...
/***/ "./src/js/modules/removeItemsMethod.js":
/*!*********************************************!*\
  !*** ./src/js/modules/removeItemsMethod.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* export default binding */ __WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(deletedItemsBtn, UI) {\r\n\tdeletedItemsBtn.addEventListener(\"click\", async () => {\r\n\r\n\t\tUI.deletedItems.innerHTML = \"\";\r\n\r\n\t\tawait fetch(\"http://localhost:8888/history\")\r\n\t\t\t.then(data => data.json())\r\n\t\t\t.then(data => data.forEach(obj => {\r\n\t\t\t\tUI.DeletedItems(obj.id, obj.title);\r\n\t\t\t}));\r\n\t})\r\n};\r\n\r\n\r\n\r\n\n\n//# sourceURL=webpack://crud/./src/js/modules/removeItemsMethod.js?");
